                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <div class="container">
                        <ul class="nav navbar-nav menu-right">
                            ...
                            <li  class="nav-icon"><a href="http://themeforest.net/user/vossendesign/portfolio" target="_blank"><i class="ion-help-buoy"></i></a></li>
                        </ul>
        ...
        <section id="works-page" class="pb100">
            <div class="container">
                <div class="row text-center">
                    ...
                    <div class="portfolio" data-gap="10"><!-- Values: 10, 15, 20, 25, 30 and 35 -->
                        ...
                        <!-- Portfolio Grid -->
                        <div id="works-grid" class="portfolio-grid works-grid portfolio-col-3" data-more-items-location="php/ajax-load-more.php">
                            ...
                            <!-- Portfolio Item -->
                            <div class="work-item digital branding" data-filter="digital">
                                <a href="project-slides.html">
                                    <div class="portfolio-item">
                                        <div class="item-caption">
                                            <h4>Wunder Hero</h4>
                    ...
                    <button id="show-more" class="btn btn-md btn-primary mt30 show-more">Show More</button>
