    ...
    <table class="table table-bordered DataTables" id="dataTable" width="100%" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <h5><b><a href="<?= base_url('admin/peserta/pesertaDetail/'.$peserta->id_peserta) ?>"><?= $peserta->nama_with_title ?></a></b></h5><div class="clearfix"></div>
            <p><?= $peserta->partisipan ?> - <?= $peserta->email ?> - <?= $peserta->institusi ?></p>
          </td>
          <td>
            <?php
