...
<div class="row">
  <div class="col-md-6">
    ...
    <?php
      ...
      echo form_open_multipart('admin/user/editReviewer/'.$reviewer->id_reviewer)

    ?>
    <form class="forms-sample" method="post">
    <input type="hidden" value="<?= $reviewer->id_reviewer ?>" name="id_reviewer">
      <div class="form-group">
        <label for="exampleInputName1">Nama</label>
        <input value="<?= $reviewer->nama_reviewer ?>" type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="nama">
      </div>
      <div class="form-group">
        <label for="exampleInputEmail3">Email</label>
        <input value="<?= $reviewer->email ?>" type="email" class="form-control" id="exampleInputEmail3" placeholder="Email" name="email">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <select name="is_aktif" id="" class="form-control">
          <option value="1" <?php if($reviewer->is_aktif=="1"){ echo "selected";} ?>>Aktif</option>
          <option value="0" <?php if($reviewer->is_aktif=="0"){ echo "selected";} ?>>Non Aktif</option>
        </select>
      </div>
      <br>
