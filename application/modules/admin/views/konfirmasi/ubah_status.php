        ...
        <div class="modal-wrapper">
          <table class="table">
            <tr>
              ...
              <td><?= $row->nama_with_title ?></td>
            </tr>  
            <tr>
              <th align="right"> Jenis Peserta </th>
              ...
              <td>
                ...
                <input type="hidden" >
                  <select name="status_pembayaran" id="" class="form-control">
                    ...
                    <option value="valid" <?php if($row->status_pembayaran=="valid"){echo "selected";} ?>>Valid</option>
                    <option value="un-Valid" <?php if($row->status_pembayaran=="un-valid"){echo "selected";} ?>>Un-Valid</option>
                  </select>
