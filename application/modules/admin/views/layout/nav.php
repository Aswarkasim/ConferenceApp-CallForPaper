			...
			<ul class="nav nav-main">
				...
				<li class="nav-parent">
					...
					<ul class="nav nav-children">
						...
						<li>
							<a href="<?php echo base_url('admin/speaker'); ?>">Speaker</a>
						</li>
						<li>
							<a href="<?php echo base_url('admin/subtema'); ?>">Sub Tema</a>
						</li>
						<li>
							<a href="<?php echo base_url('admin/seminar/readFasilitas'); ?>">Fasilitas</a>
						</li>
						<li>
							<a href="<?php echo base_url('admin/seminar/readTglPenting'); ?>">Important Date</a>
						</li>
						<li>
							<a href="<?php echo base_url('admin/seminar/readPricing'); ?>">Pricing</a>
						</li>
					</ul>
				</li>
				...
				<li>
					<a href="<?php echo base_url('admin/relat'); ?>">
						<i class="fa  fa-fax" aria-hidden="true"></i>
						<span>Instansi Relasi</span>
					</a>
				</li>
