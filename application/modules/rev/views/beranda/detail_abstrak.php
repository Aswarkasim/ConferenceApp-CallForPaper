                                        ...
                                        <div class="row mt10">
                                            ...
                                            <div class="col-md-3 pl0">
                                                ...
                                                <select name="is_accept" class="form-control mt0">
                                                    ...
                                                    <option value="perbaikan" <?php if ($abstrak->is_accept == "perbaikan") {
                                                                                    echo "selected";
                                                                                } ?>>Revise</option>
                                                    <option value="diterima" <?php if ($abstrak->is_accept == "diterima") {
                                                                                    echo "selected";
                                                                                } ?>>Accepted</option>
                                                    <option value="ditolak" <?php if ($abstrak->is_accept == "ditolak") {
                                                                                echo "selected";
                                                                            } ?>>Not Accepted</option>
                                                </select>
                                            </div>
