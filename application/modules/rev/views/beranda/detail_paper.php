                        ...
                        <div id="collapse1" class="panel-collapse open collapse in" aria-expanded="true" style="">
                            <div class="panel-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <p><i><?= $paper->author ?></i></p>
                                    <p><?= $paper->institusi ?></p>
                                </div>

                                <div class="row mt10">
                                    <div class="col-md-3">
                                        <b>Presenter</b><div class="pull-right">:</div>
                                    </div>
                                ...
                                <div class="row mt10">
                                    <div class="col-md-3">
                                        <b>File Paper</b><div class="pull-right">:</div>
                                    </div>
                                    <div class="col-md-3 pl0">
                                        <?= $paper->file ?>
                                ...
                                <div class="row mt10">
                                    ...
                                    <?php echo validation_errors('<div class="alert alert-warning"><i class="fa fa-warning"></i> ','</div>'); ?>
                                        <select name="is_accept" class="form-control mt0">
                                            ...
                                            <option value="perbaikan" <?php if($paper->is_accept=="perbaikan"){echo "selected";} ?>>Revise</option>
                                            <option value="diterima" <?php if($paper->is_accept=="diterima"){echo "selected";} ?>>Accepted</option>
                                            <option value="ditolak" <?php if($paper->is_accept=="ditolak"){echo "selected";} ?>>Not Accepted</option>
                                        </select>
                                    </div>
                                </div>
