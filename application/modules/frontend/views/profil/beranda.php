                     ...
                     <div class="panel panel-default">
                        <div class="panel-heading">
                            <button class="panel-title" data-toggle="collapse" data-target="#collapse1" aria-expanded="true">
                                <h4 class="bold"><?= $peserta->nama_with_title ?></h4>
                            </button>
                        </div>
                        <div id="collapse1" class="panel-collapse open collapse in" aria-expanded="true" style="">
                            <div class="panel-body">
                                ...
                                <div class="row mt20">
                                    ...
                                    <div class="col-md-3"><?= $peserta->nama_with_title ?></div>
                                </div>
                                ...
                                <div class="row mt20">
                                    <div class="col-md-3">Partisipasi</div>
                                    <div class="col-md-3"><?= $peserta->partisipan ?></div>
                                </div>
                                ...
                                <div class="row mt20">
                                    ...
                                    <div class="col-md-3"><?= $peserta->fax ?></div>
                                </div>
