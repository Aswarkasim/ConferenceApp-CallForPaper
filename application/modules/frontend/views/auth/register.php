                ...
                <form method="post" action="<?php echo base_url('register') ?>">
                    ...
                    <div class="row pt20">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <small value="<?= set_value('nama_with_title') ?>" class="text-muted">Contoh : Dr. Aswar Kasim, S.Pd. A.C.A.</small>
                                <input type="text" class="form-control" name="nama_with_title" placeholder="Nama dengan gelar akademik">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pt20">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select name="partisipan" id="partisipan" class="form-control mt0">
                                    <option value="">--Partisipan--</option>
                                    <option value="presenter">Presenter</option>
                                    <option value="peserta_s1">Peserta S1</option>
                                    <option value="peserta_s2">Peserta S2</option>
                                </select>
                    ...
                    <div class="row pt20">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input value="<?= set_value('fax') ?>" type="text" class="form-control" name="fax" placeholder="Fax">
                            </div>
                        </div>
                    </div>
