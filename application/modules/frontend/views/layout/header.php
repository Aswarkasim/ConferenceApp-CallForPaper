    ...
    <div class="container">
        ...
        <div class="navbar-header">
            <div class="container">
                ...
                ?>
                <a class="navbar-brand to-top" href="<?php echo base_url(); ?>"><img src="<?= base_url('assets/uploads/images/konfigurasi/' . $konfigurasi->logo) ?>" class="logo-light" alt="#"><img src="<?= base_url('assets/uploads/images/konfigurasi/' . $konfigurasi->logo) ?>" class="logo-dark" alt="#"></a>
            </div>
        </div>
